...
class CellSet(ConfiguredBaseModel):
    ...
    cellxgene_dataset: Optional[str] = Field(default=None, description="""A datasets associated with a publication.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CellSet'], 'is_a': 'dataset_identifier'} })
...
class CellType(ConfiguredBaseModel):
    ...
    label: Optional[str] = Field(default=None, description="""The name for an entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CellType',
                       'Gene',
                       'AnatomicalStructure',
                       'Species',
                       'Protein',
...
class Gene(ConfiguredBaseModel):
    ...
    gene_symbol: str = Field(default=..., description="""A unique, standardized short name for a gene, often formed by the abbreviation of the gene name, that is assigned by the HUGO Gene Nomenclature Committee (HGNC).""", json_schema_extra = { "linkml_meta": {'domain_of': ['Gene'], 'examples': [{'value': 'HSPA1B'}]} })
    label: Optional[str] = Field(default=None, description="""The name for an entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CellType',
                       'Gene',
                       'AnatomicalStructure',
                       'Species',
...
class Drug(ConfiguredBaseModel):
    ...
    name: Optional[str] = Field(default=None, description="""The name of an entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Drug']} })
    ...
    study: Optional[str] = Field(default=None, description="""A study associated with an entity.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Drug']} })
    uniprot_id: Optional[str] = Field(default=None, description="""An identifier for a protein in Uniprot.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Gene', 'Drug', 'Protein']} })
    protein_target: Optional[str] = Field(default=None, description="""A protein that is the target of a drug.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Drug']} })
...
class Publication(ConfiguredBaseModel):
    ...
    publication_doi_identifier: Optional[str] = Field(default=None, description="""A Digital Object Identifier for a publication.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Publication']} })
...
class BiomarkerCombination(ConfiguredBaseModel):
    ...
    f_beta_score: Optional[float] = Field(default=None, description="""A measure of a binary classification model's accuracy that is calculated by taking the harmonic mean of precision and recall and applying weights to recall.""", json_schema_extra = { "linkml_meta": {'domain_of': ['BiomarkerCombination'], 'slot_uri': 'STATO:0000663'} })
...
class Protein(ConfiguredBaseModel):
    ...
    species: Optional[str] = Field(default=None, description="""The taxonomical classification of an organism.""", json_schema_extra = { "linkml_meta": {'domain_of': ['CellSet', 'Gene', 'CellSetDataset', 'Protein'],
         'examples': [{'value': 'NCBITaxon:10090'}],
         'slot_uri': 'NCBITaxon:131567'} })
    gene_name: Optional[str] = Field(default=None, description="""The name of a gene.""", json_schema_extra = { "linkml_meta": {'domain_of': ['Protein']} })
...
class ClinicalTrial(ConfiguredBaseModel):
    ...
    study_id: Optional[str] = Field(default=None, description="""An identifier for a research study.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ClinicalTrial'], 'examples': [{'value': 'NCT00494511'}]} })
...
class ProteinLocatedInCellularComponent(Association):
    ...
    source: Optional[str] = Field(default=None, description="""The resource from which some information, data, or knowledge originated.""", json_schema_extra = { "linkml_meta": {'domain_of': ['ProteinLocatedInCellularComponent'], 'slot_uri': 'dc:source'} })
    subject: Optional[Protein] = Field(default=None, description="""An amino acid chain that is canonically produced de novo by ribosome-mediated translation of a genetically-encoded mRNA, and any derivatives thereof""", json_schema_extra = { "linkml_meta": {'domain_of': ['Association']} })
